                ...
                for i in data_logistik:
                    ...
                    if i == data_logistik[(kode_barang1-1)] :
                        ...
                        if certain1 == 'y':
                            ...
                            if certain2.isdigit():
                                if certain2 == '1':
                                    data_logistik[kode_barang1-1]['Kode Barang'] = input('\nSilahkan Perbaharui Kode Barang :') 
                                    print('\nData Berhasil Diperbaharui.')
                                elif certain2 == '2':
                                    data_logistik[kode_barang1-1]['Nama Barang'] = input('\nSilahkan Perbaharui Nama Barang :') 
                                    print('\nData Berhasil Diperbaharui.')
                                elif certain2 == '3':
                                    data_logistik[kode_barang1-1]['Satuan'] = input('\nSilahkan Perbaharui Satuan :') 
                                    print('\nData Berhasil Diperbaharui.')                                                           
                                elif certain2 == '4':
                                    data_logistik[kode_barang1-1]['Barang Masuk'] = int(input(f'\nSilahkan Perbaharui Barang Masuk :'))                 
                                    data_logistik[kode_barang1-1]['Stock Barang'] = data_logistik[kode_barang1-1]['Barang Masuk'] - data_logistik[kode_barang1-1]['Barang Keluar']
                                    print('\nData Berhasil Diperbaharui.')
                                elif certain2 == '5':
                                    data_logistik[kode_barang1-1]['Barang Keluar'] = int(input(f'\nSilahkan Perbaharui Barang Keluar :'))                  
                                    data_logistik[kode_barang1-1]['Stock Barang'] = data_logistik[kode_barang1-1]['Barang Masuk'] - data_logistik[kode_barang1-1]['Barang Keluar']
                                    print('\nData Berhasil Diperbaharui.')                                                             
                            else:
                                print('Masukkan Inputan yang Benar')
